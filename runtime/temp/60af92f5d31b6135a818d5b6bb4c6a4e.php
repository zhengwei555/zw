<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/activity\add.html";i:1506963096;s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    ...
    <div class="form-item">
        ...
        <div class="controls">
            <input type="text" name="create_time" class="text time" value="<?php echo (isset($info['create_time']) && ($info['create_time'] !== '')?$info['create_time']:''); ?>" placeholder="请选择时间">                    </div>
    </div>
