<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\phpStudy\WWW\twothink\public/../application/home/view/default/rental\lists.html";i:1507125514;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <div class="noticeDetailInfo"><?php echo $list['name']; ?></div>
        ...
        <h4 class="text-danger">价格:<?php echo $list['price']; ?><?php echo !empty($list['company']) && $list['company']==1?'元/月':'万元'; ?></h4>
