<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/market\index.html";i:1507041366;s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tbody>
        <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$market): $mod = ($i % 2 );++$i;?>
        <tr>
            <td><input class="ids row-selected" type="checkbox" name="" id="" value="<?php echo $activity['id']; ?>"> </td>
            <td><?php echo $market['id']; ?></td>
            <td><?php echo $market['title']; ?></a></td>
            <td><?php echo date("Y-m-d H:i:s",$market['create_time']); ?></td>
            <td><?php echo $market['description']; ?></td>
            <td><?php echo $market['view']; ?></td>
            <td>
                <a title="编辑" href="<?php echo url('edit?id='.$market['id'].'&pid='.$pid); ?>">编辑</a>
                <a class="confirm ajax-get" title="删除" href="<?php echo url('del?id='.$market['id']); ?>">删除</a>
            </td>
        </tr>
