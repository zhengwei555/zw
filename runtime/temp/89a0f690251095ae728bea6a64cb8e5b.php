<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/activity\index.html";i:1506930994;s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tbody>
        <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$activity): $mod = ($i % 2 );++$i;?>
        <tr>
            <td><input class="ids row-selected" type="checkbox" name="" id="" value="<?php echo $activity['id']; ?>"> </td>
            <td><?php echo $activity['id']; ?></td>
            <td><?php echo $activity['title']; ?></a></td>
            <td><?php echo date("Y-m-d H:i:s",$activity['create_time']); ?></td>
            <td><?php echo $activity['end_time']; ?></td>
            <td><?php echo $activity['description']; ?></td>
            <td><?php echo $activity['view']; ?></td>
            <td>
                <a title="编辑" href="<?php echo url('edit?id='.$activity['id'].'&pid='.$pid); ?>">编辑</a>
                <a class="confirm ajax-get" title="删除" href="<?php echo url('del?id='.$activity['id']); ?>">删除</a>
            </td>
        </tr>
