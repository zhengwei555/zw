<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/service\index.html";i:1506954610;s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tr>
            ...
            <td><?php echo $service['title']; ?></a></td>
            <td><?php echo date("Y-m-d H:i:s",$service['create_time']); ?></td>
            <td><?php echo !empty($service['status']) && $service['status']==1?'正常':'失效'; ?></td>
            <td><?php echo $service['view']; ?></td>
            <td>
                <a title="编辑" href="<?php echo url('edit?id='.$service['id'].'&pid='.$pid); ?>">编辑</a>
                <a class="confirm ajax-get" title="删除" href="<?php echo url('del?id='.$service['id']); ?>">删除</a>
            </td>
        </tr>
