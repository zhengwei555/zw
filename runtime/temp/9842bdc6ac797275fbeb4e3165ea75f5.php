<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpStudy\WWW\twothink\public/../application/home/view/default/repair\add.html";i:1506760764;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
        <form method="post">
            ...
            <!--<div class="form-group">-->
                ...
                <!--<div class="controls">-->
                    <!--<label class="radio"><input type="radio" name="status" value="1" >已处理</label>-->
                    <!--<label class="radio"><input type="radio" name="status" value="0" >未处理</label>-->
                <!--</div>-->
            <!--</div>-->
            <div class="form-group">
