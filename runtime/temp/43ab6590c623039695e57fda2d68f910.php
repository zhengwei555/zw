<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\www\twothink\public/../application/admin/view/default/baoxiu\edit.html";i:1506670917;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			<label class="item-label">报修编号<span class="check-tips">（必填）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="sn" value="<?php echo (isset($info['sn']) && ($info['sn'] !== '')?$info['sn']:''); ?>">
			</div>
		</div>
		<div class="form-item">
		...
		<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="area" value="<?php echo (isset($info['area']) && ($info['area'] !== '')?$info['area']:''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">详情<span class="check-tips">（必填）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="detail" value="<?php echo (isset($info['detail']) && ($info['detail'] !== '')?$info['detail']:''); ?>">
			</div>
		</div>
