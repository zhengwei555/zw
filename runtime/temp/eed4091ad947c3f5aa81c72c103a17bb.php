<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/repair\edit.html";i:1506670193;s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    <div class="form-item">
        <label class="item-label">报修人<span class="check-tips">（报修人）</span></label>
        <div class="controls">
    ...
    <div class="form-item">
        ...
        <div class="controls">
            <input type="text" class="text input-small" name="tel" value="<?php echo (isset($info['tel']) && ($info['tel'] !== '')?$info['tel']:0); ?>">
        </div>
    </div>
    <!--<div class="form-item">-->
    ...
    <!--</div>-->
    <div class="form-item">
        <label class="item-label">地址<span class="check-tips">（发生事故的地点）</span></label>
        <div class="controls">
            <input type="text" class="text input-large" name="address" value="<?php echo (isset($info['address']) && ($info['address'] !== '')?$info['address']:''); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">事故详情<span class="check-tips">（事故详情）</span></label>
        <div class="controls">
    ...
    <div class="form-item">
        ...
        <div class="controls">
            <label class="radio"><input type="radio" name="status" value="1" <?php if($info[status]==1) echo("checked");?>>已处理</label>
            <label class="radio"><input type="radio" name="status" value="0" <?php if($info[status]==0) echo("checked");?>>未处理</label>
        </div>
    </div>
